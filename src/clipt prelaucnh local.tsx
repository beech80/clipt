...
import './styles/global-scroll-fix.css';
...
const Streaming = React.lazy(() => import('./pages/StreamingPage'));
  ...
  return (
    <>
      ...
      <PageTransition>
        ...
        <Route path="/" element={user ? <Navigate to="/discover" replace /> : <Welcome />} />
        <Route path="/streaming" element={<Navigate to="/streaming/1" replace />} />
