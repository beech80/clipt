...
const SpaceLanding = () => {
  ...
  useEffect(() => {
    document.body.style.backgroundColor = '#190033';
    ...
    <div className="relative h-screen w-screen overflow-hidden bg-[#190033] flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-8">
        ...
        <div className="flex items-center justify-center gap-8">
          <motion.button
            className="flex flex-col items-center justify-center w-24 h-24 bg-orange-500 hover:bg-orange-600 rounded-md text-white"
        ...
        <motion.button
          className="mt-4 px-6 py-2 bg-[#755c3b] border border-orange-300/50 rounded text-white font-medium flex items-center justify-center text-sm"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
