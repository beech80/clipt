...
export const VideoEditor: React.FC = () => {
  ...
  const uploadAndGoToPostForm = async () => {
    ...
    try {
      setIsUploading(true);
      toast.loading("Preparing your cosmic video for upload...", { id: "video-upload" });
      ...
      toast.success("Cosmic video ready for posting!", { id: "video-upload" });
      
      // Clean up the object URL
      URL.revokeObjectURL(videoPreviewUrl);
      
      // Navigate to the post form with the video details
      navigate('/post-form', {
        state: {
