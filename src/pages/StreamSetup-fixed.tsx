                ...
                <CardContent>
                  <div className="obs-guide">
                    <div className="stream-setup-step">
                      <div>
                        <h4 className="font-semibold" style={{ color: '#FF7700' }}>Connect to Clipt</h4>
                    ...
                    <div className="stream-setup-step">
                      <div>
                        <h4 className="font-semibold" style={{ color: '#FF9A40' }}>Configure Output Settings</h4>
                    ...
                    <div className="stream-setup-step">
                      <div>
                        <h4 className="font-semibold" style={{ color: '#FFAA00' }}>Start Streaming</h4>
