  ...
  return (
    <div className="min-h-screen bg-[#1A1F2C] bg-gradient-to-b from-gaming-900/50 to-gaming-800/30">
      <div className="container mx-auto px-4 py-6 space-y-8">
        ...
        <Tabs defaultValue="games" className="w-full" onValueChange={handleTabChange}>
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="games">Games</TabsTrigger>
            <TabsTrigger value="streamers">Streamers</TabsTrigger>
          </TabsList>
          
          {/* Search bar that appears for both tabs */}
          <div className="relative max-w-md mx-auto mb-8">
            <Input
              placeholder={`Search ${activeTab === 'games' ? 'games' : 'streamers'}...`}
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pr-10 bg-gaming-800/50 border-gaming-700"
            />
