...
const RetroMessagesContainer = styled(motion.div)`
  ...
  background-image: linear-gradient(135deg, #1a0d00 0%, #2a1500 50%, #1a0d00 100%);
  color: #ffe0cc;
  overflow: hidden;
  position: relative;
`;
...
const RetroChatBox = styled.div`
  ...
  background-image: linear-gradient(135deg, rgba(50, 25, 0, 0.2) 0%, rgba(40, 20, 0, 0.3) 100%);
`;
  ...
  return (
    <div className="h-screen">
      ...
      <SimpleAlertDialog 
        ...
        title="Report User"
        description="Please provide a reason for reporting this user. Our moderation team will review your report."
        confirmLabel="Submit Report"
        cancelLabel="Cancel"
        confirmButtonClassName="bg-orange-600 hover:bg-orange-700 text-white py-2 px-4 rounded"
        onConfirm={() => {
