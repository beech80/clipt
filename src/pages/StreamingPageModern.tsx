        ...
        <div style={{
          ...
          <motion.button
            ...
            style={{
              ...
              alignItems: 'center',
              gap: '5px',
              backgroundColor: showFilters ? 'rgba(255, 85, 0, 0.3)' : 'rgba(255, 255, 255, 0.1)',
              border: showFilters ? '1px solid rgba(255, 85, 0, 0.5)' : '1px solid rgba(255, 255, 255, 0.2)',
              borderRadius: '5px',
              padding: '8px 15px',
              color: showFilters ? '#FF5500' : 'white',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
              fontWeight: 'bold',
              boxShadow: showFilters ? '0 0 10px rgba(255, 85, 0, 0.2)' : 'none'
            }}
          >
            <Filter size={20} />
          </motion.button>
                ...
                {genres.map(genre => (
                  <motion.button
                    ...
                    style={{ 
                      ...
                      alignItems: 'center',
                      gap: '5px',
                      backgroundColor: selectedGenre === genre.id ? 'rgba(255, 85, 0, 0.3)' : 'rgba(30, 30, 30, 0.6)',
                      border: selectedGenre === genre.id ? '1px solid rgba(255, 85, 0, 0.5)' : '1px solid rgba(255, 255, 255, 0.1)',
                      borderRadius: '5px',
                      padding: '8px 15px',
                      color: selectedGenre === genre.id ? '#FF5500' : 'white',
                      cursor: 'pointer',
                      fontSize: '14px',
                      fontWeight: 'bold',
                      transition: 'all 0.2s ease'
