...
import { ArrowLeft, User, Settings, Planet, Rocket, Star, Command, Save } from "lucide-react";
  ...
  if (!authUser) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#050B1F] to-[#0A1232] text-white p-4">
        <Planet className="w-16 h-16 text-purple-400 mb-4" />
      ...
      <div className="sticky top-0 z-20 backdrop-blur-sm bg-gradient-to-r from-[#0E1A3D]/80 to-[#1A123E]/80 border-b border-indigo-500/20">
        <div className="px-4 py-3 max-w-7xl mx-auto">
          <Button 
            ...
            className="text-white hover:bg-indigo-500/20 p-2"
          >
          ...
          <div className="flex justify-center items-center h-[80vh] relative z-10">
            ...
            >
              <motion.div 
                ...
                className="mb-6"
              >
                <Planet className="w-16 h-16 text-purple-400" />
              </motion.div>
          ...
          >
            ...
            <div className="max-w-3xl mx-auto px-4 py-6">
              ...
              >
                ...
                {/* Form Footer */}
                <div className="px-6 py-4 bg-indigo-900/20 border-t border-indigo-500/20 flex justify-between items-center">
                  <div className="text-sm text-indigo-300">
                    Changes save automatically
                  </div>
                  <div className="flex items-center">
                    <Save className="w-4 h-4 text-green-400 mr-1" />
                    <span className="text-sm text-green-400">Profile data secure</span>
                  </div>
                </div>
              </motion.div>
            </div>
