  ...
  return (
    <div className="h-14 bg-[#1e2130] fixed bottom-0 left-0 right-0 z-50 border-t border-[#3e4462]/30 flex items-center justify-between px-5">
      ...
      <div className="w-16 h-16 relative">
        <div className="absolute transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-[76px] h-[76px] bg-gradient-to-b from-[#444752] to-[#262734] rounded-full shadow-lg">
          <div className="absolute transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-14 h-14 bg-[#262734] rounded-full border-2 border-[#1e2130]">
            <div className="absolute transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-8 h-8 bg-[#1e2130] rounded-full border border-[#34363F]"></div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="absolute w-[68px] h-[68px] rounded-full" 
          style={{ 
            background: 'linear-gradient(135deg, #4f9cf9 0%, #a651fb 50%, #f046ff 100%)',
          }}>
          <div className="absolute transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-[64px] h-[64px] rounded-full bg-[#1e2130] flex items-center justify-center text-white">
            <div className="flex flex-col items-center justify-center">
              ...
              <span className="text-[10px] font-bold mt-1">CLIPT</span>
            </div>
          </div>
        </div>
      </button>
      ...
      <div className="w-16 h-16 relative">
        ...
        <button 
          onClick={handleLike}
          className="absolute -top-3 left-1/2 transform -translate-x-1/2 focus:outline-none"
          aria-label="Like"
        >
        ...
        <button 
          onClick={handleRank}
          className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 focus:outline-none"
          aria-label="Rank"
        >
