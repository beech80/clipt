      ...
      <div className={`gameboy-controls-container ${!shouldHideBackground ? 'with-background' : ''} ${isCliptsPage ? 'clipts-controller' : ''}`}>
        ...
        <div className="center-control-area">
          ...
          <div className="menu-buttons">
            <button className="menu-button menu-button-small" onClick={() => navigate('/select')} aria-label="Menu">
            ...
            <button className="menu-button menu-button-small" onClick={() => navigate('/create')} aria-label="Create">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
